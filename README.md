In the package com.sn.driverManager three .java files are there to insert a record, delete a record and update data from STUDENT table by connecting with DB using DriverManager class.
